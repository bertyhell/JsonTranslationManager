...
namespace JsonTranslationManager.LanguageService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private JsonTranslationManager.LanguageService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public JsonTranslationManager.LanguageService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        JsonTranslationManager.LanguageService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, JsonTranslationManager.LanguageService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, JsonTranslationManager.LanguageService.Translation[] translations, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        JsonTranslationManager.LanguageService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, JsonTranslationManager.LanguageService.TranslateOptions options);
        ...
        JsonTranslationManager.LanguageService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options);
        ...
        JsonTranslationManager.LanguageService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : JsonTranslationManager.LanguageService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<JsonTranslationManager.LanguageService.LanguageService>, JsonTranslationManager.LanguageService.LanguageService {
        ...
        public JsonTranslationManager.LanguageService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, JsonTranslationManager.LanguageService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, JsonTranslationManager.LanguageService.Translation[] translations, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public JsonTranslationManager.LanguageService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, JsonTranslationManager.LanguageService.TranslateOptions options) {
        ...
        public JsonTranslationManager.LanguageService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public JsonTranslationManager.LanguageService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, JsonTranslationManager.LanguageService.TranslateOptions options) {
